  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onClose}>
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-auto border-none shadow-2xl bg-card/95 backdrop-blur-xl rounded-3xl">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1.5">
                <Button 
                  variant="outline" 
                  size="sm" 
                  className="h-9 px-3 rounded-xl gap-1.5 border-border/50 bg-secondary/30 hover:bg-secondary/50" 
                ...
                <Button 
                  variant="outline" 
                  size="sm" 
                  className="h-9 px-3 rounded-xl gap-1.5 border-border/50 bg-secondary/30 hover:bg-secondary/50 text-amber-600 hover:text-amber-700" 
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {lead.tags && lead.tags.length > 0 ? lead.tags.map((tag) => (
                    <span key={tag} className="px-3 py-1.5 rounded-xl text-xs font-bold bg-primary/10 text-primary border border-primary/20 flex items-center gap-1.5">
                ...
                {timeline.length > 0 ? timeline.map((ev, i) => (
                  <div key={ev.id} className="relative flex gap-4">
                    ...
                    <div className="flex-1 space-y-1">
                      <div className="p-3 rounded-2xl bg-secondary/20 border border-border/30 shadow-sm">
