            ...
            <div className="space-y-2">
              {group.nodes.map((node) => {
                ...
                return (
                  <div
                    key={node.type}
                    className="flex items-center gap-3 p-3 border border-border rounded-lg bg-secondary/50 cursor-grab active:cursor-grabbing hover:bg-secondary hover:border-[#ff9500]/30 transition-colors shadow-sm"
