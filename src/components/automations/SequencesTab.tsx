    ...
    <div className="space-y-3">
      ...
      {sequences.length === 0 ? (
        ...
        sequences.map((seq) => {
          ...
          return (
            <div key={seq.id} className="bg-card ghost-border rounded-xl overflow-hidden shadow-card hover:shadow-card-hover hover:border-[#ff9500]/30 transition-all duration-200">
              <button
