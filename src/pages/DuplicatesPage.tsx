      ...
      <div className="p-6 max-w-4xl mx-auto space-y-6 animate-fade-in">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <Button
            ...
            className="bg-primary hover:bg-[#e08300] text-primary-foreground shrink-0"
          >
        ...
        {scanned && groups.length > 0 && (
          <div className="bg-card ghost-border rounded-xl p-4 space-y-3">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button
                size="sm"
                className="h-8 text-xs gap-1.5 bg-primary hover:bg-[#e08300] text-primary-foreground"
          ...
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction
                ...
                disabled={bulkMerging}
                className="bg-primary hover:bg-[#e08300] text-primary-foreground"
              >
