  ...
  return (
    <AppLayout title="Integrações" subtitle="Conecte seus canais e ferramentas ao uPixel">
      <div className="p-6 space-y-8 animate-fade-in">
        {/* Canais */}
        <div>
          <h2 className="text-sm font-semibold text-foreground mb-3">Canais de comunicação</h2>
...
function IntegrationCard({ integration: int, active, onToggle }: { integration: Integration; active: boolean; onToggle: (v: boolean) => void }) {
  ...
  return (
    <div className="bg-card border border-border rounded-lg p-5 hover:border-border-hover transition-colors flex flex-col">
