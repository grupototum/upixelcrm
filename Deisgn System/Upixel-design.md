...
version: '1.0'
name: Zapier
description: The typographic system is a deliberate interplay of two distinct personalities. **Degular Display** -- a geometric, wide-set display face -- handles hero-scale headlines at 56-80px with medium weight (500) and extraordinarily tight line-heights (0.90), creatin
source:
...
rounded:
  ...
  full: 9999px
preview_tokens:
  button_primary_bg: '#201515'
  button_primary_text: '#ffffff'
  button_primary_border: '#201515'
  button_secondary_bg: transparent
  button_secondary_text: '#201515'
  button_secondary_border: '#eceae3'
  button_tertiary_text: '#c5c0b1'
  surface_bg: '#fffefb'
  card_bg: '#fffefb'
  text: '#201515'
  text_muted: '#939084'
