...
# PROMPT 3 — AUTENTICAÇÃO E PERMISSÕES

Audite autenticação, autorização, sessão e controle de acesso.
...
- Há autorização apenas no frontend?
- Há uso inseguro de service role?
- Há tokens expostos?
- Há sessão longa demais?
- Há fluxo de convite vulnerável?
- Há forma de revogar acesso?
- Há MFA apropriado?
- Há auditoria de ações sensíveis?
