...
# PROMPT 2 — BANCO DE DADOS E STORAGE

Audite PostgreSQL, Supabase e toda a persistência.
...
- cascatas perigosas
- JSONB usado sem critério
- funções críticas no banco
- migrations não reprodutíveis
...
- ranking de queries críticas
- revisão de índices
- revisão de RLS
- estratégia de migrations
- estratégia de backup
- arquitetura mínima segura e escalável
- plano de correção
