...
# PROMPT 4 — MULTI-TENANCY

Audite profundamente o isolamento entre organizações, empresas, contas e usuários.
...
Descreva testes práticos para tentar acessar dados de outro tenant por URL, API, query, exportação, storage, cache, IDs previsíveis e automações.
