...
# PROMPT 16 — REVISÃO FINAL PÁGINA POR PÁGINA

Execute esta etapa por último.

## Objetivo

Revisar cada página, modal, fluxo e estado da aplicação individualmente.

## Para cada tela, responda

- Qual é o objetivo?
- O usuário entende em cinco segundos?
- Qual é a principal ação?
- Há complexidade desnecessária?
- Há excesso de informação?
- Há passos removíveis?
- Há funcionalidade faltando?
- Há oportunidade de automação?
- Há oportunidade de IA?
- Há erro de hierarquia?
- Há inconsistência?
- Há problema de acessibilidade?
- Há problema de responsividade?
- Há risco de conversão?
- Há estado vazio?
- Há loading?
- Há erro?
- Há confirmação?
...
Compare com padrões de produtos como Apple, Linear, Notion, HubSpot, Stripe, Vercel e Raycast, sem copiar estética ou fluxo cegamente.
...
- melhorias com IA
- melhorias com automação
- wireframe textual quando necessário
