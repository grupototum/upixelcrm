...
# PROMPT 14 — REVISÃO FINAL DE BANCO DE DADOS

Execute esta etapa somente após concluir API, segurança, multi-tenancy, hosting, cache, escalabilidade, logs e alta disponibilidade.

## Objetivo

Revisar o banco novamente à luz de todas as decisões anteriores e produzir o desenho final.
