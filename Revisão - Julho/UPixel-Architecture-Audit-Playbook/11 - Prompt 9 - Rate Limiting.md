...
# PROMPT 9 — RATE LIMITING E PROTEÇÃO CONTRA ABUSO

Audite limites, throttling e proteção contra automação abusiva.
...
- enumeração
- DDoS
- limites por IP, usuário, tenant e token

## Entregáveis específicos

- inventário de superfícies
- limites recomendados
- estratégia de armazenamento de contadores
- respostas padrão
- retry-after
