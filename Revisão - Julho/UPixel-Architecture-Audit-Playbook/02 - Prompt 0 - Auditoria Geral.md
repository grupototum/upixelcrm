...
# PROMPT 0 — AUDITORIA GERAL DE ARQUITETURA

Faça uma leitura completa do UPixel CRM antes de aprofundar qualquer camada.

## Objetivo

Entender o sistema como um todo, identificar fronteiras, dependências, acoplamentos, duplicidades, dívida arquitetural e divergências entre documentação e implementação.

## Investigue

- estrutura de pastas
- frontend, backend, serviços, funções, workers e automações
- bibliotecas e frameworks
- integrações externas
- Supabase Cloud versus Self-Hosted
- variáveis de ambiente e configuração
- fluxo de autenticação
- multi-tenancy
- banco, storage, filas, cache e logs
- Vercel, VPS, containers e deploy
- CI/CD
- segurança
...
- Qual é a arquitetura real hoje?
- Quais camadas existem de fato?
- Quais camadas estão misturadas?
- Onde há acoplamento indevido?
- Onde há risco de vazamento de dados?
- Quais decisões parecem provisórias?
- O sistema suporta crescimento?
- O sistema é compreensível para um novo desenvolvedor?
- O que pode quebrar silenciosamente?
- O que precisa ser estabilizado antes de qualquer refatoração?

## Entregáveis específicos

- diagrama textual da arquitetura atual
- mapa de dependências internas e externas
...
- top 10 quick wins
- arquitetura mínima aceitável
- ordem recomendada para os próximos prompts
