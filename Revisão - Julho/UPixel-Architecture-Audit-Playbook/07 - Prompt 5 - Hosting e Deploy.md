...
# PROMPT 5 — HOSTING E DEPLOY

Audite a estratégia atual de hospedagem e publicação.

## Contexto conhecido a validar

- VPS
- Vercel
- Supabase Self-Hosted ou híbrido
...
Compare o desenho atual com alternativas plausíveis e modernas, considerando custo, simplicidade, performance, lock-in, escalabilidade e manutenção.
